/*To understand the concept of indexes*/
...
/*Create a reverse index on employee_id column of the EMPLOYEES.*/
CREATE INDEX IDX ON EMPLOYEES(EMPLOYEE_ID DESC);
/*Create a unique and composite index on employee_id and check whether there is duplicity 
of tuples or not.*/
...
DROP INDEX EMPLOYEE_IDX ON EMPLOYEES;
